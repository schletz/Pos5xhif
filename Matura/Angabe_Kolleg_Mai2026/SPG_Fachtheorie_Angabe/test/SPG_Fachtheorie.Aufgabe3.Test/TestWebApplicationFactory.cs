...
public class TestWebApplicationFactory : WebApplicationFactory<Program>
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        {
            var descriptor = services.First(d => d.ServiceType == typeof(DbContextOptions<ReservationContext>));
    ...
    public void InitializeDatabase(Action<ReservationContext> action)
    {
        using var scope = Services.CreateScope();
        using var db = scope.ServiceProvider.GetRequiredService<ReservationContext>();
    ...
    public Tout QueryDatabase<Tout>(Func<ReservationContext, Tout> query)
    {
        using var scope = Services.CreateScope();
        using var db = scope.ServiceProvider.GetRequiredService<ReservationContext>();
        return query(db);
