...
namespace Weatherservice
{
    ...
    class WeatherserviceException : Exception
    {
        ...
        public WeatherserviceException(string message, [CallerMemberName] string methodName = "") : base(message)
        {
            MethodName = methodName;
        }
        public WeatherserviceException(string message, Exception innerException, [CallerMemberName] string methodName = "") : base(message, innerException)
        {
            MethodName = methodName;
        }
